package test.ProgramPersonProtected;

//import test.Program.Person;

public  class Program {
    public static void main(String[] args) {

        Person kate = new Person("Kate", 32, "Baker Street", "+1234567");

        kate.displayName(); // норм. метод public
        kate.displayAge(); //  норм. метод иимеет модификатор по умолчанию,
